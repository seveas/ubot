...
# This is an example project that enables all applications to run ubot and its
# default helpers
...
DATABASES = {
    'default': {
        ...
        'NAME': 'ubot',                       # Or path to database file if using sqlite3.
        'USER': 'ubot',                       # Not used with sqlite3.
        'PASSWORD': 'ub0t',                   # Not used with sqlite3.
